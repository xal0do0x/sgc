 ...
 * @author Gabriel
 */
public class DlgColaboradorBusqueda extends javax.swing.JDialog {
     ...
     * @param componente
     */
    public DlgColaboradorBusqueda(Component componente) {
...
//            this.dispose();
            if(this.padre instanceof frmMantEmpresas){
                ...
                ((frmMantCreditoPersonas) padre).colaborador = listaPersonas.get(jTablePersonas.getSelectedRow());
                listaPersonas.remove(jTablePersonas.getSelectedRow());
                this.dispose();
            }else{
                this.dispose();
