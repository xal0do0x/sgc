...
public class frmMantPrestamista extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanelDatosLayout.columnWidths = new int[] {0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0, 7, 0};
        jPanelDatosLayout.rowHeights = new int[] {0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0};
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        jPanelDatos.add(txtNombre, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 8;
        ...
        jComboBoxTipo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " ", "PERSONA NATURAL", "PERSONA JURIDICA" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 24;
        gridBagConstraints.gridwidth = 61;
        ...
        jComboBoxIdentificacion.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " ", "RUC", "DNI" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.gridwidth = 33;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        jPanelDatos.add(jComboBoxIdentificacion, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        // TODO add your handling code here:
        if (txtNombre.getText().equals("") || txtidentificacion.getText().equals("") || jComboBoxIdentificacion.getSelectedIndex()==0 || jComboBoxTipo.getSelectedIndex()==0 || txtDireccion.getText().equals("")) {
            ...
            controladorPersona.getSeleccionado().setNombre(txtNombre.getText().trim().toUpperCase());          
    ...
    private javax.swing.JComboBox jComboBoxIdentificacion;
    ...
    public void presentarDatos() {
        ...
        BeanProperty bNombres = BeanProperty.create("nombre");
        BeanProperty bIdentificacion = BeanProperty.create("tipoIdentificacion");        
        BeanProperty bNum_identificacion = BeanProperty.create("numIdentificacion");
        BeanProperty bTipo_persona = BeanProperty.create("tipoPersona");
        ...
        binding.addColumnBinding(bIdentificacion).setColumnName("TipoIdent.").setEditable(false);
        binding.addColumnBinding(bNum_identificacion).setColumnName("Ident.").setEditable(false);
        binding.addColumnBinding(bTipo_persona).setColumnName("TipoPers.").setEditable(false);
    ...
    public int getTipoCliente(String dato){
        int index = 0;
        switch (dato) {
            case "P":
                index = 1;
